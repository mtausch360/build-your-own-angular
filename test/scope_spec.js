...
describe("Scope", function() {
  ...
  describe("digest", function() {
    ...
    it("allows destryoing a $watch with a removal function", function() {
  ...
  describe('$watchGroup', function() {
    ...
    it('does not call the zero-watch listener when deregistered first', function() {
      ...
      var destroyGroup = scope.$watchGroup([], function() {
        counter++;
      });
  ...
  describe("inheritance", function() {
    ...
    it("inherits the parent's properites whenever they are defined", function() {
      var parent = new Scope();
      var child = parent.$new();
    ...
    it("cant watch a property in the parent", function() {
      var parent = new Scope();
      var child = parent.$new();
      parent.aValue = [1, 2, 3];
      child.counter = 0;
    ...
    describe("isolated scopes", function() {
      ...
      it("digests its isolated childrend", function() {
        var parent = new Scope();
        var child = parent.$new(true);
      ...
      it("scehdules a digest from root on $evalAsync when isolated", function(done) {
        var parent = new Scope();
        var child = parent.$new(true);
        var child2 = child.$new();
    ...
    describe("$watchCollection", function() {
      ...
      it("notices an iterm added to an array", function() {
        scope.arr = [1, 2, 3];
      ...
      it("notices a replaced item in an array", function() {
      ...
      it("doest not fail on NaN attributes in objs", function() {
        scope.counter = 0;
        scope.obj = {
          a: NaN
        };
      ...
      it("does not consider any object with a length property of an array", function() {
    ...
    describe("Events", function() {
      ...
      _.forEach(['$emit', '$broadcast'], function(method) {
        ...
        it("does not stop on exceptions on " + method, function() {
          var listener1 = function(event) {
            throw 'listener1 throwning exception';
          };
          var listener2 = jasmine.createSpy();
      ...
      it("attaches to currentScope on $emit", function() {
